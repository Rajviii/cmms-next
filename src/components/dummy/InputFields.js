...
const InputFields = () => {
    ...
    return (
      <div className="row example-wrapper" style={{ minHeight: 450 }}>
        ...
        {/* ColorPicker - does not show the cross on the screen but in the console shows License error */}
        {/* <div className="col-12 col-md-6 example-col">
          <p>ColorPicker</p>
          <ColorPicker />
        </div> */}
        {/* ColorGradient - does not show the cross on the screen but in the console shows License error */}
        {/* <div className="col-12 col-md-6 example-col">
          <p>ColorGradient</p>
          <ColorGradient />
        </div> */}
